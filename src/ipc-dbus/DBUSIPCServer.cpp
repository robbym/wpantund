...
IntrospectionCache introspection_cache (Node()
	.add(Node("com")
		.add(Node("nestlabs")
			.add(Node("WPANTunnelDriver")
				.add(Node("wpan0")
					.add(Interface("com.nestlabs.WPANTunnelDriver")
						.add(Method("Form")
							.add(Arg("name", "s", "in"))
							.add(Arg("b", "n", "in"))
							.add(Arg("c", "u", "in"))
		...
		.add(Node("wpantund")
			.add(Node("wpan0")
				...
				.add(Interface("org.wpantund.v1")
					...
					.add(Method("Reset"))
					.add(Method("PropGet")
						.add(Arg("property", "s", "in"))
						.add(Arg("status", "i", "out"))
						.add(Arg("result", "v", "out"))
					)
					.add(Method("PropSet")
						.add(Arg("property", "s", "in"))
						.add(Arg("value", "s", "in"))
					...
					.add(Method("JoinerAdd")
						.add(Arg("psk", "s", "in"))
						.add(Arg("timeout", "u", "in"))
					)
					// .add(Method("BeginLowPower"))
					// .add(Method("HostDidWake"))
					// .add(Method("Attach"))
					// .add(Method("Join")
					// 	.add(Arg("a", "s", "in"))
					// 	.add(Arg("b", "n", "in"))
